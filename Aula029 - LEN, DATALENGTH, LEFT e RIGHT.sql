...
*/
    ...
    SELECT LEN('O melhor canal do YouTube é o DevDojo, brabo demais!') AS [LEN],
           ...
           LEFT('O melhor canal do YouTube é o DevDojo, brabo demais!', ( LEN('O melhor canal do YouTube é o DevDojo, brabo demais!')/2 ) ) AS [LEFT (LEN/2)],
           RIGHT('O melhor canal do YouTube é o DevDojo, brabo demais!', ( LEN('O melhor canal do YouTube é o DevDojo, brabo demais!')/2 ) ) AS [RIGHT (LEN/2)],
