...
/*
    ...
    SPACE(Números de espaços): Acrescentará a quantidade de espaços
    LOWER(Nome da coluna): Retornará tudo em minúsculo
    UPPER(Nome da coluna): Retornará tudo em maiúsculo
*/
